...
contract KlickZieIco is PausableToken {
    using SafeMath for uint256;

    string public name = "KlickZie Token";
    string public symbol = "KLK";
    ...
    function KlickZieIco(
        ...
        preSaleEndTimestamp = preSaleStartTimestamp + 10 days;
